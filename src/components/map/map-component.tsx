...
export default function MapComponent({ categories }: { categories: any }) {
    ...
    const handleCategorySelectorChange = (
        layer_id: string,
        checked: boolean,
    ) => {
                        ...
                        render={() => (
                            <FormItem>
                                <div className="mb-4">
                                    ...
                                    <FormDescription>
                                        Select the categories you wish to appear
                                        on the map.
                                    </FormDescription>
                                </div>
        ...
        if (mapRef && mapRef.current) {
            ...
            mapRef.current?.on('click', 'clusters', e => {
                ...
                if (e.features && e.features?.length > 0) {
                    ...
                    const mapSource: any =
                        mapRef.current?.getSource(pointsLayerId);
                    ...
                    console.log(
                        'Clusters onClick event coordinates: ' + coordinates,
                    );
                }
            });
            ...
            mapRef.current?.on('click', 'unclustered-point', e => {
                ...
                if (e.features && e.features[0].geometry.type === 'Point') {
                    ...
                    console.log(
                        'Unclusters onClick event coordinates: ' + coordinates,
                    );
            ...
            mapRef.current?.on('mouseenter', clusterLayer.id ?? '', e => {
                ...
                if (e.features && e.features[0].geometry.type === 'Point') {
                    ...
                    console.log(
                        'clusterLayer mouseenter event coordinates: ' +
                            coordinates,
                    );
                    // Ensure that if the map is zoomed out such that
                    // multiple copies of the feature are visible, the
                    ...
                    console.log(
                        'clusterLayer mouseenter event properties: ',
                        properties,
                    );
                }
            });
        ...
        /> */}
          ...
          cluster={true}
                ...
                >
                    ...
                    <Layer
                        {...{ source: pointsLayerId, ...clusterCountLayer }}
                    />
                    <Layer
                        {...{ source: pointsLayerId, ...unclusteredPointLayer }}
                    />
                    {testPlaces}
                </Source>
                <CustomOverlay>
