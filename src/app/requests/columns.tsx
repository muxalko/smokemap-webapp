...
export function ModerationActions({
  ...
  canApprove,
  canDelete,
}: ModerationCapabilities & { request: RequestType }) {
  return (
    <>
      {canApprove && (
        <Button
          ...
          onClick={async () => {
            try {
              ...
              clogger.warn("Approval was denied or failed");
            }
          }}
        >
          Approve
            ...
            <DropdownMenuItem
              ...
              onClick={async () => {
                try {
                  ...
                  clogger.warn("Deletion was denied or failed");
                }
              }}
            >
              Delete
...
export function createColumns({
  canApprove,
  canDelete,
}: ModerationCapabilities): Array<ColumnDef<RequestType, unknown>> {
  return [
